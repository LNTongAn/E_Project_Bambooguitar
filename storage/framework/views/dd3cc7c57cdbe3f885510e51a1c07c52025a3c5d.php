        ...
        <div class="background_about">
            ...
            <div class="row">
                <div class="col l-6 m-6 c-12">
                    <img style="padding-left: 20px;" src="<?php echo e(url('img/about.png')); ?>" alt="" width="100%">
                </div>
                <div class="col l-6 m-6 c-12">
                    <h3>Our Mission</h3>
            ...
            <div style="padding-left: 50px; padding-right: 50px;">
                <div class="row">
                    <div class="col col l-2-4 m-4 c-12">
                        <img class="img_about" src="<?php echo e(asset('member/img/avatar04.png')); ?>" alt="">
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\project-sem2\resources\views/home/about.blade.php ENDPATH**/ ?>