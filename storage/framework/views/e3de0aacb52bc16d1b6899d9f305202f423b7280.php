    ...
    <div class="grid wide">
        <div class="background_contact">
            ...
            <div class="row">
                ...
                <div class="col l-6 m-6 c-12">
                    <form action="<?php echo e(url('home/SendMailContact')); ?>">
                        <div class="row">
                            <div class="col l-6 m-6 c-12">
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\project-sem2\resources\views/home/contact.blade.php ENDPATH**/ ?>