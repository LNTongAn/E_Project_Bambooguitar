        ...
        <div class="row">
            <div class="offset-md-3 col-md-6">
                ...
                <div class="card card-success">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="<?php echo e(url('admin/product/postUpdate/'.$p->id)); ?>" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('layout.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\project-sem2\resources\views/admin/product/update.blade.php ENDPATH**/ ?>